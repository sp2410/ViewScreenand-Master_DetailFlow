...
import com.example.sangeeta.hw2.R;
...
public class MovieData {
    ...
    private HashMap<String, java.io.Serializable> createMovie(String name, int image, String description, String year,
															  String length, double rating, String director, String stars, String url) {
        HashMap<String, java.io.Serializable> movie = new HashMap<String, java.io.Serializable>();
